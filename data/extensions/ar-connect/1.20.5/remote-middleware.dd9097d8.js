  ...
  (function (r, t, n, o, a) {
  ...
  })(
    {
      ieuE1: [
        ...
        {
          tslib: "bGRfT",
          "../../core/environment": "lBXbB",
          "../../lib/load-script": "6nimb",
          "../../lib/parse-cdn": "7c03H",
      ...
      bGRfT: [
        function (e, r, t) {
          ...
          n.defineInteropFlag(t),
            ...
            n.export(t, "__awaiter", () => _),
            n.export(t, "__generator", () => v),
            n.export(t, "__createBinding", () => b),
            n.export(t, "__exportStar", () => h),
            n.export(t, "__values", () => m),
            n.export(t, "__read", () => w),
            n.export(t, "__spread", () => g),
            n.export(t, "__spreadArrays", () => x),
            n.export(t, "__spreadArray", () => j),
            n.export(t, "__await", () => O),
            n.export(t, "__asyncGenerator", () => P),
            n.export(t, "__asyncDelegator", () => E),
            n.export(t, "__asyncValues", () => S),
            n.export(t, "__makeTemplateObject", () => A),
            n.export(t, "__importStar", () => D),
            n.export(t, "__importDefault", () => I),
            n.export(t, "__classPrivateFieldGet", () => G),
            n.export(t, "__classPrivateFieldSet", () => F),
            n.export(t, "__classPrivateFieldIn", () => R),
            n.export(t, "__addDisposableResource", () => k),
          ...
          function u(e, r, t, n, o, a) {
            ...
            for (
              ...
              var v = (0, t[d])("accessor" === s ? { get: f.get, set: f.set } : f[l], y)
              if ("accessor" === s) {
                if (void 0 === v) continue
                if (null === v || "object" != typeof v) throw TypeError("Object expected")
                ;(c = i(v.get)) && (f.get = c),
                  (c = i(v.set)) && (f.set = c),
                  (c = i(v.init)) && o.unshift(c)
              } else (c = i(v)) && ("field" === s ? o.unshift(c) : (f[l] = c))
            }
          ...
          function h(e, r) {
            for (var t in e)
              "default" === t || Object.prototype.hasOwnProperty.call(r, t) || b(r, e, t)
          }
          function m(e) {
          ...
          function D(e) {
            ...
            if (null != e)
              for (var t in e)
                "default" !== t && Object.prototype.hasOwnProperty.call(e, t) && b(r, e, t)
            return T(r, e), r
          }
          function I(e) {
          ...
          function K(e) {
            function r(r) {
              ;(e.error = e.hasError
                ? new M(r, e.error, "An error was suppressed during disposal.")
                : r),
                (e.hasError = !0)
            }
            return (function t() {
      ...
      "7c03H": [
        ...
        {
          "./global-analytics-helper": "fco3u",
          "./embedded-write-key": "kX0ax",
          "@parcel/transformer-js/src/esmodule-helpers.js": "f6DG4",
        },
      ],
      fco3u: [
