  ...
  (function (t, r, n, o, i) {
    ...
    function u(e, r) {
      if (!f[e]) {
        ...
        ;(g.resolve = function (r) {
          var n = t[e][1][r]
          return null != n ? n : r
        }),
          (g.cache = {})
        var c = (f[e] = new u.Module(e))
        t[e][0].call(c.exports, g, c, c.exports, this)
      }
      return f[e].exports
      function g(e) {
        var t = g.resolve(e)
  ...
  })(
    {
      "5Taji": [
        function (e, t, r) {
          ...
          n.defineInteropFlag(r), n.export(r, "config", () => s)
          ...
          document.addEventListener("DOMContentLoaded", async () => {
            let e = document.querySelectorAll(
                'a[href^="ar://"], img[src^="ar://"], iframe[src^="ar://"], audio > source[src^="ar://"], video > source[src^="ar://"], link[href^="ar://"], embed[src^="ar://"], object[data^="ar://"],script[src^="ar://"]',
              ),
              t = {
            ...
            for (let r of e)
              try {
                ...
                ;(0, i.isString)(e?.url),
                  ...
                  "SOURCE" === r.tagName
                    ? r.parentNode.load()
                    : "LINK" === r.tagName && r.parentNode.replaceChild(r.cloneNode(), r)
              } catch {
                console.error(`Failed to load ar:// resource: ${r[t[r.tagName]]}`)
              }
          })
        },
        {
      ...
      "2dl6a": [
        function (e, t, r) {
          ...
          i.defineInteropFlag(r),
            ...
            i.export(r, "getCurrentContext", () => k),
            i.export(r, "isInternalEndpoint", () => m),
            i.export(r, "onMessage", () => R),
            i.export(r, "onOpenStreamChannel", () => D),
            i.export(r, "openStream", () => P),
            i.export(r, "parseEndpoint", () => p),
            i.export(r, "sendMessage", () => C),
            i.export(r, "setNamespace", () => E)
          var s = e("nanoevents"),
            a = e("webextension-polyfill"),
            f = i.interopDefault(a),
            l = e("serialize-error"),
            u = e("tiny-uid"),
            c = i.interopDefault(u),
            g =
            ...
            d = h("devtools")
              ...
              : h("tabs")
                ? (() => {
                    var e, t, r
                    let n = (0, f.default).runtime.getManifest()
          ...
          async function I() {
            ...
            if (
              (("window" === d || "content-script" === d) && window.addEventListener("message", T),
              "content-script" === d &&
                top === window &&
                ((v = (0, f.default).runtime.connect()).onMessage.addListener((e) => {
                  _(e)
                }),
              ...
              let { tabId: e } = f.default.devtools.inspectedWindow,
                t = `devtools@${e}`
              ;(v = (0, f.default).runtime.connect(void 0, { name: t })).onMessage.addListener(
                (e) => {
                  _(e)
                },
              ),
            ...
            if ("popup" === d || "options" === d) {
              let e = `${d}`
              ;(v = (0, f.default).runtime.connect(void 0, { name: e })).onMessage.addListener(
                (e) => {
                  _(e)
                },
              ),
            ...
            if ("web_accessible" === d) {
              let e = await (0, f.default).tabs.query({ active: !0, currentWindow: !0 }),
                { id: t } = e[0],
                r = `web_accessible@${t}`
              ;(v = (0, f.default).runtime.connect(void 0, { name: r })).onMessage.addListener(
                (e) => {
                  _(e)
                },
              ),
            ...
            "background" === d &&
              (0, f.default).runtime.onConnect.addListener((e) => {
          ...
          function _(e) {
            ...
            if (
              ...
              if (!r) return O(e)
              if (r.context) {
                if ("window" === d) return U(window, e)
                if ("content-script" === d && "window" === r.context)
                  return (e.destination = null), U(window, e)
                if (
                ...
                if ("background" === d) {
                  ...
                  i && (a = `${a}.${i}`)
                  let f = x.get(a)
                  f ? f.postMessage(e) : w.add({ resolvedDestination: a, message: e })
                }
              }
            }
          }
          ...
          async function T({ data: e, ports: t }) {
          ...
          async function C(e, t, r = "background") {
            ...
            return new Promise((r, o) => {
              let i = {
                ...
                destination: n,
                messageType: "message",
                transactionId: (0, c.default)(),
                origin: { context: d, tabId: null },
                hops: [],
                timestamp: Date.now(),
              }
              A.set(i.transactionId, { resolve: r, reject: o }), _(i)
            })
          }
          I()
          var N = class {
              constructor(e) {
                ;(this.handleStreamClose = () => {
                  ...
                  (this.isClosed = !1),
                  N.initDone ||
                    (R("__crx_bridge_stream_transfer__", (e) => {
                      let { streamId: t, streamTransfer: r, action: n } = e.data,
                        o = N.openStreams.get(t)
                      o &&
                        !o.isClosed &&
                        ("transfer" === n && o.emitter.emit("message", r),
                        "close" === n && (N.openStreams.delete(t), o.handleStreamClose()))
                    }),
                    (N.initDone = !0)),
                  N.openStreams.set(e.streamId, this)
              }
              get info() {
          ...
          var M = new Map(),
            j = new Map(),
            L = (0, s.createNanoEvents)()
          async function P(e, t) {
            if (M.has(e)) throw Error("webext-bridge: A Stream is already open at this channel")
            let r = "string" == typeof t ? p(t) : t,
              n = { streamId: (0, c.default)(), channel: e, endpoint: r },
              o = new S(n)
            return (
              o.onClose(() => M.delete(e)),
              await C("__crx_bridge_stream_open__", n, r),
              M.set(e, o),
              o
            )
          }
          function D(e, t) {
            ...
            j.set(e, t), L.emit("did-change-stream-callbacks")
          }
          R(
                ...
                let { sender: r, data: n } = e,
                  ...
                  a = () => {
                    ...
                    "function" == typeof e
                      ...
                      : i || ((i = !0), (s = L.on("did-change-stream-callbacks", a)))
                  }
                a()
              }),
          )
                    ...
                    let n = (e) => e && "object" == typeof e && "function" == typeof e.then,
                        ...
                        return new Proxy(o, {
                          ...
                          get(o, i, u) {
                            ...
                            if ("function" == typeof c) {
                              if ("function" == typeof t[i]) c = a(e, e[i], t[i])
                              else if (f(r, i)) {
                                let t = s(i, r[i])
                                c = a(e, e[i], t)
                              } else c = c.bind(e)
                            } else if ("object" == typeof c && null !== c && (f(t, i) || f(r, i)))
                              c = l(c, t[i], r[i])
                            else {
                              if (!f(r, "*"))
                                return (
                      ...
                      c = new r((e) =>
                        "function" != typeof e
                          ? e
                          : function (t) {
                              let r = l(t, {}, { getContent: { minArgs: 0, maxArgs: 0 } })
                              e(r)
                            },
                      ),
                      g = !1,
                      ...
                      d = {
                        devtools: { network: { onRequestFinished: u(c) } },
                        runtime: {
                          onMessage: u(p),
      ...
      lhUKN: [
        function (e, t, r) {
          ...
          let s = [
            ...
            l = ({ from: e, seen: t, to_: r, forceEnumerable: n, maxDepth: i, depth: u }) => {
              let c = r || (Array.isArray(e) ? [] : {})
              if ((t.push(e), u >= i)) return c
              if ("function" == typeof e.toJSON && !0 !== e[a]) return f(e)
          ...
          function u(e, t = {}) {
            ...
            return "object" == typeof e && null !== e
              ? l({ from: e, seen: [], forceEnumerable: !0, maxDepth: r, depth: 0 })
              : "function" == typeof e
          ...
          function c(e, t = {}) {
            ...
            if ("object" == typeof e && null !== e && !Array.isArray(e)) {
              let t = Error()
              return l({ from: e, seen: [], to_: t, maxDepth: r, depth: 0 }), t
            }
            return new i(e)
          }
        },
      ...
      "89Y7O": [
        function (e, t, r) {
            ...
            h = c((e) => {
              ;(e.read = function (e, t, r, n, o) {
                var i,
                  ...
                  p = e[t + c]
                for (
                  c += g, i = p & ((1 << -u) - 1), p >>= -u, u += a;
                  u > 0;
                  i = 256 * i + e[t + c], c += g, u -= 8
                );
                for (
                  s = i & ((1 << -u) - 1), i >>= -u, u += n;
                  u > 0;
                  s = 256 * s + e[t + c], c += g, u -= 8
                );
                if (0 === i) i = 1 - l
                else {
                  if (i === f) return s ? NaN : (p ? -1 : 1) * (1 / 0)
                  ;(s += Math.pow(2, n)), (i -= l)
                }
                  ...
                  for (
                    isNaN((t = Math.abs(t))) || t === 1 / 0
                      ...
                      : ((s = Math.floor(Math.log(t) / Math.LN2)),
                        ...
                        s + c >= 1 ? (t += g / f) : (t += g * Math.pow(2, 1 - c)),
                        t * f >= 2 && (s++, (f /= 2)),
                        s + c >= u
                          ? ((a = 0), (s = u))
                          : s + c >= 1
                            ? ((a = (t * f - 1) * Math.pow(2, o)), (s += c))
            ...
            d = c((e) => {
              ...
              function y(e, t, r, n, o) {
                ...
                if (("string" == typeof t && (t = i.from(t, n)), i.isBuffer(t)))
                  return 0 === t.length ? -1 : A(e, t, r, n, o)
                if ("number" == typeof t)
                  return (
                    (t &= 255),
              ...
              ;(e.Buffer = i),
                ...
                (i.compare = function (e, t) {
                  if (
                    (L(e, Uint8Array) && (e = i.from(e, e.offset, e.byteLength)),
                    L(t, Uint8Array) && (t = i.from(t, t.offset, t.byteLength)),
                ...
                (i.prototype.compare = function (e, t, r, n, o) {
                  if ((L(e, Uint8Array) && (e = i.from(e, e.offset, e.byteLength)), !i.isBuffer(e)))
                    throw TypeError(
                ...
                (i.prototype.readBigUInt64LE = D(function (e) {
                  R((e >>>= 0), "offset")
                  let t = this[e],
                    r = this[e + 7]
                ...
                (i.prototype.readBigUInt64BE = D(function (e) {
                  R((e >>>= 0), "offset")
                  let t = this[e],
                    r = this[e + 7]
                  ;(void 0 === t || void 0 === r) && C(e, this.length - 8)
                ...
                (i.prototype.readBigInt64LE = D(function (e) {
                  R((e >>>= 0), "offset")
                  let t = this[e],
                    r = this[e + 7]
                  return (
                ...
                (i.prototype.readBigInt64BE = D(function (e) {
                  R((e >>>= 0), "offset")
                  let t = this[e],
                    r = this[e + 7]
                  return (
                ...
                (i.prototype.writeBigUInt64LE = D(function (e, t = 0) {
                  return v(this, e, t, BigInt(0), BigInt("0xffffffffffffffff"))
                })),
                (i.prototype.writeBigUInt64BE = D(function (e, t = 0) {
                ...
                (i.prototype.writeBigInt64LE = D(function (e, t = 0) {
                  return v(this, e, t, -BigInt("0x8000000000000000"), BigInt("0x7fffffffffffffff"))
                })),
                (i.prototype.writeBigInt64BE = D(function (e, t = 0) {
              ...
              function k(e, t, r, n, o, i) {
                if (e > r || e < t) {
                  ...
                  throw (
                    ...
                    new O.ERR_OUT_OF_RANGE("value", o, e))
                  )
                }
                R(o, "offset"), (void 0 === n[o] || void 0 === n[o + i]) && C(o, n.length - (i + 1))
              }
              function R(e, t) {
              ...
              function C(e, t, r) {
                throw Math.floor(e) !== e
                  ? (R(e, r), new O.ERR_OUT_OF_RANGE(r || "offset", "an integer", e))
                  : t < 0
                    ? new O.ERR_BUFFER_OUT_OF_BOUNDS()
                    : new O.ERR_OUT_OF_RANGE(
                        r || "offset",
          ...
          ;((e, t) => {
            ...
            (t.exports = g(s({}, "__esModule", { value: !0 }), y))
          var A = p(d())
          ;(n = p(d())), (o = t.exports), g(y, n, "default"), o && g(o, n, "default")
          var b = A.default /*! Bundled license information:
...
*/
      ...
      "62Y1j": [
        function (e, t, r) {
          ...
          let o = r.defaultAssert
          function i(e, t = n("not null")) {
            ;(0, r.assert)(null !== e, t)
          }
          function s(e, t = n("not undefined")) {
            ;(0, r.assert)(void 0 !== e, t)
          }
          function a(e, t = n("a string")) {
            ;(0, r.assert)("string" == typeof e, t)
          }
          function f(e, t = n("a record")) {
            for (let n of ((0, r.assert)("object" == typeof e, t), i(e, t), Object.keys(e))) a(n, t)
          }
          function l(e, t = n("an array")) {
            ;(0, r.assert)(Array.isArray(e), t)
          }
          function u(e, t, o = n("an instance of given constructor")) {
            ;(0, r.assert)(e instanceof t, o)
          }
          ;(r.assert = (e, t) => o(e, t)),
            ...
            (r.isExactly = function (e, t, o = n(`exactly ${t}`)) {
              ;(0, r.assert)(e === t, o)
            }),
            ...
            (r.isRecordOfType = function (
              ...
              for (let n of (f(e, r), Object.values(e))) t(n, o)
            }),
            (r.isArrayOfType = function (
              ...
              for (let n of (l(e, r), e)) t(n, o)
            }),
            (r.isOptionOfType = function (e, t, r = n("option of given type")) {
              void 0 !== e && t(e, r)
            }),
            (r.isOneOf = function (e, t, o = n(`one of ${t.join(", ")}`)) {
              ;(0, r.assert)(t.includes(e), o)
            }),
            (r.isOneOfType = function (e, t, r = n("one of type"), o) {
              for (let r of t)
                try {
                  r(e, o)
                  return
