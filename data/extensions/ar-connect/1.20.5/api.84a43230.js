...
"function" == typeof (e = globalThis.define) && ((t = e), (e = null)),
  (function (t, r, n, o, i) {
  ...
  })(
    {
      "5zQpY": [
        function (e, t, r) {
          e("cc7e65f06df1d551").register(
            JSON.parse('{"6JjJi":"api.84a43230.js","c5qIT":"injected.c3d8f555.js"}'),
          )
        },
        { cc7e65f06df1d551: "i6vFE" },
      ],
      i6vFE: [
        function (e, t, r) {
          var n = {}
      ...
      "6dckM": [
        function (e, t, r) {
          ...
          n.defineInteropFlag(r), n.export(r, "config", () => a)
          ...
          let a = {
            ...
            f = document.head || document.documentElement,
            l = document.createElement("script")
          l.setAttribute("async", "false"),
            l.setAttribute("type", "text/javascript"),
            l.setAttribute("src", s.default),
            f.insertBefore(l, f.children[0]),
            f.removeChild(l),
            window.addEventListener("message", async ({ data: e }) => {
              if ("arconnect" !== e.ext) return
              if (!e.callID) throw Error("The call does not have a callID")
              let t = await (0, o.sendMessage)(
                "chunk" === e.type ? "chunk" : "api_call",
                e,
                "background",
              )
      ...
      "2dl6a": [
        function (e, t, r) {
          ...
          var C = class {
                  ...
                  C.initDone ||
                    (R("__crx_bridge_stream_transfer__", (e) => {
                      let { streamId: t, streamTransfer: r, action: n } = e.data,
                        o = C.openStreams.get(t)
                      o &&
                        !o.isClosed &&
                        ("transfer" === n && o.emitter.emit("message", r),
                        "close" === n && (C.openStreams.delete(t), o.handleStreamClose()))
                    }),
                    (C.initDone = !0)),
                  C.openStreams.set(e.streamId, this)
              }
              get info() {
            ...
            L = C
          ;(L.initDone = !1), (L.openStreams = new Map())
          var S = new Map(),
            j = new Map(),
            P = (0, s.createNanoEvents)()
          async function N(e, t) {
            if (S.has(e)) throw Error("webext-bridge: A Stream is already open at this channel")
            let r = "string" == typeof t ? p(t) : t,
              n = { streamId: (0, c.default)(), channel: e, endpoint: r },
              o = new L(n)
            return (
              o.onClose(() => S.delete(e)),
      ...
      "89Y7O": [
        function (e, t, r) {
          var n,
            ...
            d = c((e) => {
                ...
                (i.prototype.write = function (e, t, r, n) {
                  ...
                  for (;;)
                    switch (n) {
                      ...
                      case "utf8":
                      case "utf-8":
                        return (o = t), (i = r), j(L(e, this.length - o), this, o, i)
                      case "ascii":
                      case "latin1":
                      case "binary":
                        return (
              ...
              function O(e, t, r, n, o, i) {
                ...
                R(o, "offset"), (void 0 === n[o] || void 0 === n[o + i]) && M(o, n.length - (i + 1))
              }
              function R(e, t) {
              ...
              function M(e, t, r) {
                throw Math.floor(e) !== e
                  ? (R(e, r), new T.ERR_OUT_OF_RANGE(r || "offset", "an integer", e))
                  : t < 0
          ...
          ;((e, t) => {
            ...
            (t.exports = g(s({}, "__esModule", { value: !0 }), A))
          var y = p(d())
          ;(n = p(d())), (o = t.exports), g(A, n, "default"), o && g(o, n, "default")
...
*/
      ...
      fxAiN: [
        function (e, t, r) {
          t.exports =
            e("a6a0fbde2981ea0e").getBundleURL("6JjJi") + e("9188bdae79f9abb").resolve("c5qIT")
        },
        { a6a0fbde2981ea0e: "87g1w", "9188bdae79f9abb": "i6vFE" },
      ],
      "87g1w": [
        function (e, t, r) {
          var n = {}
